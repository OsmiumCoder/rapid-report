...
export default function ToggleSwitch({ checked, onChange }: ToggleSwitchProps) {
    return (
        <Switch
            checked={checked}
            onChange={onChange}
            className="group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-upei-green-600 focus:ring-offset-2 data-[checked]:bg-upei-green-600"
        >
        ...
        >
          <svg fill="currentColor" viewBox="0 0 12 12" className="size-3 text-upei-green-600">
