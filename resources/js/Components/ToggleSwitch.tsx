...
export default function ToggleSwitch({ checked, onChange }: ToggleSwitchProps) {
    return (
        <Switch
            checked={checked}
            onChange={onChange}
            className="group focus:ring-upei-green-500 data-[checked]:bg-upei-green-500 relative mt-2 inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-offset-2 focus:outline-hidden"
        >
