...
interface IndexFilterProps {
    ...
    setFilters: Dispatch<SetStateAction<Record<string, Filter[]>>>;
    resetFilters: () => void;
}
            ...
            (prev, current) =>
                ...
                current.reduce(
                    (prevInner, currentInner) =>
                        prevInner + (currentInner.checked ? 1 : 0),
                    0
                ),
            0
        );
            ...
            >
                    ...
                    <div className="mx-auto flex divide-x divide-gray-200 text-sm ml-2 mt-2">
                        ...
                        >
                            ...
                            >
                                <FunnelIcon
                                    aria-hidden="true"
                                    className="mr-2 size-5 flex-none"
                                />
                ...
                <DisclosurePanel className="border-t border-gray-200 py-10">
                    <div className="max-w-7xl gap-x-4 px-4 text-sm sm:px-6 md:gap-x-6">
                        <div className="grid grid-cols-1 items-stretch gap-x-6 gap-y-6 md:grid-cols-3 md:gap-x-6">
                            {Object.entries(filters).map(
                                ([filterName, filter], filterIndex) => (
                                    <>
                                        <fieldset
                                            key={filterIndex + filterName}
                                            className="space-y-4 max-h-48 sm:max-h-64 overflow-x-scroll"
                                        >
