            ...
            <div className="mt-4 flex w-3/4 flex-wrap justify-around">
                ...
                >
                    <div className="relative">
                        <ComboboxInput
                            className="focus:outline-upei-green-600 block w-full rounded-md bg-white py-1.5 pr-12 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 sm:text-sm/6"
                            ...
                            {filteredSupervisors.length > 0 ? (
                                filteredSupervisors.map((supervisor) => (
                                    <ComboboxOption
                                        key={supervisor.id}
                                        value={supervisor.id}
                                        className="group data-[focus]:bg-upei-green-600 relative cursor-default py-2 pr-9 pl-3 text-gray-900 select-none data-[focus]:text-white data-[focus]:outline-hidden"
                                    >
                                        <div>
                                        ...
                                        {supervisor.id === incident.supervisor_id && (
                                            <span className="text-upei-green-600 absolute inset-y-0 right-0 flex items-center pr-4 group-data-[focus]:text-white">
