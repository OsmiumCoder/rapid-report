                        ...
                        <div className="mt-6 flex w-full flex-col gap-y-6 border-t border-gray-900/5 p-6">
                            {canProvideFollowup && (
                                <>
                                    <Link
                                        ...
                                        as="button"
                                        className="cursor-pointer bg-upei-green-500 hover:bg-upei-green-400 focus-visible:outline-upei-green-600 rounded-md px-3 py-2 text-center text-sm font-semibold text-white shadow-xs focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                                    >
                            ...
                            {canRequestReview && (
                                <Link
                                    ...
                                    method="patch"
                                    as="button"
                                    className="cursor-pointer bg-upei-red-500 hover:bg-upei-red-400 focus-visible:outline-upei-red-600 rounded-md px-3 py-2 text-center text-sm font-semibold text-white shadow-xs focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                                >
                                    Request Review
                                </Link>
                            )}
