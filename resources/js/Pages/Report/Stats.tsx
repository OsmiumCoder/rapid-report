...
export default function Stats({
    ...
    const data: dataEntry[] = [
        ...
        {
            labels: ['From affected', 'On Behalf'],
            entries: [on_behalf_dist[0], on_behalf_dist[1]],
            entries_number: 2,
            title: 'On Behalf',
            description: 'Distribution of On Behalf Incidents',
        },
        {
            labels: ['Not Anonymous on behalf', 'Anonymous on Behalf'],
            entries: [on_behalf_anon_dist[0], on_behalf_anon_dist[1]],
            entries_number: 2,
