...
class ExportXLSXTest extends TestCase
{
    public function test_xlsx_exported_download_response()
    {
        ...
        $response = $this->actingAs($admin)->post(route('report.export-xlsx'), $exportData->toArray());
    ...
    public function test_xlsx_exported()
    {
        ...
        Excel::assertDownloaded("{$exportData->start->toDateString()}-to-{$exportData->end->toDateString()}.xlsx", function (IncidentsExport $export) {
    ...
    public function test_throws_validation_error_for_bad_data()
    {
        ...
        $response = $this->actingAs($admin)->post(route('report.export-xlsx'), $exportData);
    ...
    public function test_user_is_forbidden()
    {
        ...
        $response = $this->actingAs($user)->post(route('report.export-xlsx'), $exportData->toArray());
    ...
    public function test_supervisor_is_forbidden()
    {
        ...
        $response = $this->actingAs($supervisor)->post(route('report.export-xlsx'), $exportData->toArray());
