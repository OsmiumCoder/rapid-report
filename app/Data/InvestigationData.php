...
class InvestigationData extends Data
{
     ...
     * @param string[] $resulted_in The result of the incident occurring and how it affected all parties.
     * @param string[]|null $substandard_acts Optional. Factors deemed as substandard acts that contributed to the incident.
     * @param string[]|null $substandard_conditions Optional. Factors deemed as substandard conditions that contributed to the incident.
     * @param string[]|null $energy_transfer_causes Optional. Physical exertion factors that contributed to the incident.
     * @param string[]|null $personal_factors Optional. Factors related to the individuals state that contributed to the incident.
     * @param string[]|null $job_factors Optional. Factors related to the workplace environment that contributed to the incident.
     */
