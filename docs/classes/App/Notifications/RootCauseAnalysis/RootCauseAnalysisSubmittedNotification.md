...
# RootCauseAnalysisSubmittedNotification





* Full name: `\App\Notifications\RootCauseAnalysis\RootCauseAnalysisSubmittedNotification`
...
```php
public __construct(string $incidentSlug, string $rootCauseAnalysisId, \App\Models\User $supervisor): mixed
```
