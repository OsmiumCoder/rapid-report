...
# RootCauseAnalysisReturnedNotification





* Full name: `\App\Notifications\RootCauseAnalysis\RootCauseAnalysisReturnedNotification`
...
```php
public __construct(string $incidentSlug, string $rootCauseAnalysisId, \App\Models\User $admin): mixed
```
