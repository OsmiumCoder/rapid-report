...
# InvestigationReturnedNotification





* Full name: `\App\Notifications\Investigation\InvestigationReturnedNotification`
...
```php
public __construct(string $incidentSlug, string $investigationId, \App\Models\User $admin): mixed
```
