...
# FilesUploadedNotification





* Full name: `\App\Notifications\Incident\FilesUploadedNotification`
...
```php
public __construct(string $incidentSlug, \App\Models\User $user): mixed
```
