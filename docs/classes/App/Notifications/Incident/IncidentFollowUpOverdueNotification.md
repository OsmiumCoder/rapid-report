...
# IncidentFollowUpOverdueNotification





* Full name: `\App\Notifications\Incident\IncidentFollowUpOverdueNotification`
...
```php
public withDelay(object $notifiable): array&lt;string,\Illuminate\Support\Carbon&gt;
```
...
```php
public shouldSend(object $notifiable, string $channel): bool
```
